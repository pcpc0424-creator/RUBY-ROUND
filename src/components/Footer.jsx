          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                aria-label="카카오톡 채널"
                className="w-10 h-10 rounded-lg bg-dark-700 flex items-center justify-center text-gray-400 hover:text-[#FEE500] hover:bg-dark-600 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-yellow-500/20 group"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="인스타그램"
                className="w-10 h-10 rounded-lg bg-dark-700 flex items-center justify-center text-gray-400 hover:text-[#E4405F] hover:bg-dark-600 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-pink-500/20 group"
              >
                <svg className="w-5 h-5 transition-transform duration-300 group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="페이스북"
                className="w-10 h-10 rounded-lg bg-dark-700 flex items-center justify-center text-gray-400 hover:text-[#1877F2] hover:bg-dark-600 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20 group"
              >
                <svg className="w-5 h-5 transition-transform duration-300 group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
